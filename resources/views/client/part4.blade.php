                        ...
                        @foreach($questions as $key => $question)
                            <div class="form-group">
                                ...
                                <label class="radio-inline">
                                    <input type="radio" name="{{ $key+1 }}" value="4" required @if($saved_input[$key+1] == "3") checked @endif> Very Important
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="{{ $key+1 }}" value="3" required @if($saved_input[$key+1] == "2") checked @endif> Important
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="{{ $key+1 }}" value="2" required @if($saved_input[$key+1] == "1") checked @endif> Somewhat Important
                                </label>
                            </div>
