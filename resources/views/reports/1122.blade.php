    ...
    <tr>
        <td>
            ...
            @if($data["part6"] == "5")
                ...
                <p>Your investment ‘appetite for risk’ is the extent to which you feel comfortable accepting a certain level of risk associated with a particular asset class or sub class. Your appetite for risk is a result of your generics, (DNA) and how this is shaped through your experiences. This includes key messages from your parents and significant others from birth. Psychologists believe these messages are accepted as truths by the brain with little filtering up until around age 7. Repeated messages create deep neural pathways in the brain that are ingrained and unconscious. Such ‘financial programming’ is passed on from parent to child, generation to generation, significantly influencing both your perception of what constitutes an acceptable level of risk and your subsequent investment decision-making. For example, a belief formed at an early age and reinforced over time that ‘debt is bad’ may cause an investor to avoid investment debt structuring despite it being a legitimate wealth creation strategy.</p>

                <p>Self-awareness is of your own psychology is critical. It is vital to understand your own financial programming and how it influences your investment decision-making in order to make better investment decisions. Your profile indicates that you are comfortable with all asset classes in the moderate to high investment risk category and other categories below, as indicated in the ‘Asset Pyramid’ above. This indicates that are comfortable with both defensive and growth assets that could include FX currency trading (FOREX), options, Australian and International equities, blue chip stocks, collectables, residential, industrial and/or commercial real estate, listed property vehicles, fixed interest, government bonds, corporate bonds, mortgages and some hybrid securities. It also indicates that you are also comfortable to bank deposits, terms deposits, savings and cheque accounts, cash management trusts, bullion and cash equivalents.</p>
            ...
            @elseif($data["part6"] == "1")
                ...
                <p>Self-awareness is of your own psychology is critical. It is vital to understand your own financial programming and how it influences your investment decision-making in order to make better investment decisions. Your profile indicates that you are comfortable with all asset classes in the low investment risk category as indicated in the ‘Asset Pyramid’ above. This indicates that are most comfortable with defensive assets that could include bank deposits, terms deposits, savings and cheque accounts, cash management trusts, bullion and cash equivalents.</p>
            ...
            {{--<p>Investment decision-making represents an inner struggle between your rational mind and your emotions. Ultimately, the level of appropriate risk depends upon three factors; your investment appetite for risk, your financial objectives and the amount of time you have to reach your financial objectives, i.e. your ‘investment window’. Talk to your trusted adviser about your portfolio construction and appropriate asset classes most suitable for you given your risk profile, investment goals and your investment window of opportunity.--}}
            {{--</p>--}}
